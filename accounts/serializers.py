...
class SignupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('email', 'password', 'password2', 'username', 'profile_image', 'name', 'birthdate','gender', 'introduction')
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email', 'username', 'profile_image', 'followings', 'followers', 'follower_count', 'following_count','profile_image']  # 반환할 필드
